package dev.grubfx.healthconnect.ui.viewmodels
...
import dev.grubfx.healthconnect.DataExporterScheduleWorker
...
val dataExportRequest: PeriodicWorkRequest = PeriodicWorkRequestBuilder<DataExporterScheduleWorker>(
    repeatInterval = 24,
...
class ExporterBackgroundWorkViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun scheduleWork() {
        workManager.enqueueUniquePeriodicWork(
            WORK_NAME, ExistingPeriodicWorkPolicy.UPDATE, dataExportRequest
        )
